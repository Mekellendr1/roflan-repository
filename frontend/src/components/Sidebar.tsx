          ...
          <div className="flex-1 min-w-0">
            {renameMode ? (
              ...
              <div className="flex items-center gap-1">
                <button
                  onClick={() => setOpen((s) => !s)}
                  className="flex-1 min-w-0 text-left hover:opacity-75 transition-opacity cursor-pointer"
                  aria-haspopup
                  aria-expanded={open}
                ...
                >
                  ...
                  <p className="text-xs text-gray-500 leading-tight">{currentRole ?? 'v1.0'}</p>
                </button>
                <button
                  onClick={() => setOpen((s) => !s)}
                  className={`p-1 text-gray-400 hover:text-gray-600 transition-transform flex-shrink-0 cursor-pointer ${open ? 'rotate-180' : ''}`}
                  title="Выбрать проект"
                >
                ...
                <button
                  ...
                  className="p-1 text-gray-400 hover:text-blue-600 hover:bg-blue-50 rounded-lg transition-colors flex-shrink-0 cursor-pointer"
                  title="Переименовать"
                >
